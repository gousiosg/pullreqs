...
\fbox{
\begin{minipage}{0.46\textwidth}
  \emph{RQ4: 32\% of pull requests are discarded due to concurrent
  modifications of code in project branches and forks while 20\% are rejected
  due to project process and quality requirements not being met. Only 13\% 
  of the pull requests are rejected due to technical reasons.}
\end{minipage}}
