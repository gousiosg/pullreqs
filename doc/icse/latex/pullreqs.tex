...
February to August 2012, 315,522 original repositories received a single
...
the same period in 2013; from the 1,157,625 repositories that received a
...
\emph{RQ1: 14\% of repositories are using pull requests on Github. Pull request usage is increasing in absolute numbers, even though the proportion of repositories using pull requests has decreased slightly.}
\end{minipage}}
%
