...
into three categories:
  ...
  \emph{Pull request characteristics.} These
    ...
    features, namely \texttt{src\_churn} and \texttt{test\_churn}. Finally,
    the number of participants has been shown to influence the time to process
    of code reviewing~\cite{Rigby13}.
...
\emph{RQ1: 14\% of repositories are using pull requests on Github. Pull request usage is increasing in absolute numbers, even though the proportion of repositories using pull requests is relatively stable.}
\end{minipage}}
%
