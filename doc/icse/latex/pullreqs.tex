...
examine 293 carefully selected Ruby, Python, Java and Scala projects (in total,
168,028 pull requests), and identify, using  
...
requirements discussion tool~\footnote{Github uses this internally:
\url{https://github.com/blog/1124-how-we-use-pull-requests-to-build-github}} or
as a progress tracking tool towards the fulfilment of a project milestone. In
...
After creating the data files, we investigated cases where the
pull request merge ratio was significantly less (in some cases, as small as
10\%) than the one we calculated across Github (73\%), as this means that our
heuristics are not inclusive enough. This way, we filtered out 12 projects,
which we did not replace. 

The final dataset consisted of 293 projects (95 Python, 92 Java, 84 Ruby, 14
Scala) and 168,028 data points (59,284, 55,672, 45,901 and 7,576 for Python,
...
statistically significant ($n = 168,028, p < 0.001$).
...
To investigate the reasons of why pull requests are not merged and the , we
manually examined random
