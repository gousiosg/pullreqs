...
\begin{abstract}
  ...
  first the {\sc ght}orrent corpus and then on a carefully selected sample of 88
  ...
  time to incorporate contributions. Moreover, we have shown that a relatively
...
example, identical work team structures emerge (the ``onion''
...
and processing time. We find that the pull request model offers fast turnaround,
increased opportunities for community engagement and significantly decreased
time to incorporate contributions.  Moreover, we have shown that a relatively
small number of factors, which can be optimized by the project or the
contributor, affect both the decision to merge a pull request and the time to
process it. 
