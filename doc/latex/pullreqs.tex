...
The merged pull request percentage is almost normally distributed among projects (Shapiro-Wilkes test: $n = 82, p > 0.06$) with a standard deviation $\sigma = 14.68$. This means than we can expect that more than half pull requests will be merged, across any project, with a 66\% probability. \todo{Slightly extrapolating here, but still\ldots}
...
\centering
\subfigure {
  \includegraphics[scale=0.4]{varimp-merge-decision-all-50.pdf} 
  \label{fig:varimp-merge-decision}
}
\subfigure{
\includegraphics[scale=0.4]{varimp-merge-time-all-50.pdf}
